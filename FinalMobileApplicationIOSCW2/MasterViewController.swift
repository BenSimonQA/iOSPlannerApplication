...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func insertNewObject(_ sender: Any) {
        ...
        newAssessment.name = "Mathematics"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let assessmentName = self.fetchedResultsController.fetchedObjects?[indexPath.row].name
        {
            cell.labelAssessment?.text = assessmentName
        }
        else{
            cell.labelAssessment?.text = ""

        }
        if let moduleName = self.fetchedResultsController.fetchedObjects?[indexPath.row].module
        {
            cell.labelModule?.text = moduleName
        }
        else{
            cell.labelModule?.text = ""

        }
        if let aDueDate = self.fetchedResultsController.fetchedObjects?[indexPath.row].dueDate
        {
            cell.labelDueDate?.text = aDueDate
        }
        else{
            cell.labelDueDate?.text = ""

        }
        if let aValue = self.fetchedResultsController.fetchedObjects?[indexPath.row].aValue
        {
            cell.labelValue?.text = "Value: " + aValue
        }
        else{
            cell.labelValue?.text = ""

        }
        if let aMark = self.fetchedResultsController.fetchedObjects?[indexPath.row].aMark
        {
            cell.labelMark?.text = "Mark: " + aMark
        }
        else{
            cell.labelMark?.text = ""
